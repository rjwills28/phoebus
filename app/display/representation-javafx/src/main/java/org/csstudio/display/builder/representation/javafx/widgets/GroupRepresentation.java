...
public class GroupRepresentation extends JFXBaseRepresentation<Pane, GroupWidget>
{
    ...
    public static final BorderWidths EDIT_NONE_BORDER = new BorderWidths(0.5, 0.5, 0.5, 0.5, false, false, false, false);
    public static final BorderStrokeStyle EDIT_NONE_DASHED = new BorderStrokeStyle(
            StrokeType.INSIDE,
